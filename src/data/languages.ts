...
export const languages: Language[] = [
...

  {
    ...
    tooltips: {
      ...
      concurrency:
        "Virtual Threads (Java 21 / Project Loom) let you write blocking code that scales like async — millions of lightweight threads, runtime-scheduled. Combined with java.util.concurrent and CompletableFuture, Java 21 is now a genuinely strong concurrency platform.",
    },
...

  {
    ...
    concurrency: 6,
    typeStrength: 8,
    performanceLabel: "Very Good — AOT native",
    memoryLabel: "Moderate",
